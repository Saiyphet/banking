                                ...
                                <form name="addemp" method="POST">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="form-group">
                                            <label for="example-text-input" class="col-form-label"> ລະຫັດພະນັກງານ</label>
                                        ...
                                        <div class="form-group">
                                            <label class="col-form-label">ພະແນກ</label>
                                        ...
                                        <div class="form-group">
                                            <label class="col-form-label">ເພດ</label>
                                            <select class="custom-select" name="gender" autocomplete="off">
                                                <option value="">ກາລຸນາເລືອກ..</option>
                                                <option value="Male">ຊາຍ</option>
                                                <option value="Female">ຍິງ</option>
                                                <option value="Other">ອື້ນໆ</option>
                                            </select>
                                        </div>

                                        <div class="form-group">
                                            <label for="example-date-input" class="col-form-label">ວັນເດືອນປີເກີດ</label>
                                            <input class="form-control" type="date" name="dob" id="birthdate" >
                                        </div>

                                        <div class="form-group">
                                            <label for="example-text-input" class="col-form-label">ເບີຕິດຕໍ່</label>
                                            <input class="form-control" name="mobileno" type="tel"  maxlength="11" autocomplete="off" required>
                                        </div>
                                        ...
                                        <h4>ກາລຸນາເພີ່ມລະຫັດເພື່ອເຂົ້າສູ້ລະບົບ</h4>
                                        ...
                                        <div class="form-group">
                                            <label for="example-text-input" class="col-form-label">ຍືນຍັນລະຫັດຜ່ານ</label>
                                            <input class="form-control" name="confirmpassword" type="password" autocomplete="off" required>
                                        </div>

                        

                                        <button class="btn btn-primary" name="add" id="update" type="submit" onclick="return valid();">ດຳເນີນການ</button>
