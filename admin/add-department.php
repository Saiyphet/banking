                ...
                <div class="row align-items-center">
                    <div class="col-sm-6">
                        <div class="breadcrumbs-area clearfix">
                            <h4 class="page-title pull-left">ພະແນກ</h4>
                            <ul class="breadcrumbs pull-left">
                                <li><a href="department.php">ພະແນກ</a></li>
                                <li><span>Add</span></li>
                        ...
                        <?php if($error){?><div class="alert alert-danger alert-dismissible fade show"><strong>Info: </strong><?php echo htmlentities($error); ?>
                                ...
                                <form method="POST">
                                 <div class="card-body">
                                        ...
                                        <p class="text-muted font-14 mb-4">ກາລຸນາເພີ່ມພະແນກໃຫ້ຖືກຕ້ອງ</p>

                                        <div class="form-group">
                                            <label for="example-text-input" class="col-form-label"> ຊື້ພະແນຫ</label>
                                            <input class="form-control" name="departmentname" type="text" required id="example-text-input" >
                                        </div>

                                        <div class="form-group">
                                            <label for="example-text-input" class="col-form-label">ຂະແໜງ</label>
