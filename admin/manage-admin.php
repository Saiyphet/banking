                    ...
                    <div class="col-12 mt-5">
                        ...
                        <?php if($error){?><div class="alert alert-danger alert-dismissible fade show"><strong>Info: </strong><?php echo htmlentities($error); ?>
                            ...
                            <div class="card-body">
                                ...
                                <center><a href="add-admin.php" class="btn btn-sm btn-info">ເພີ່ມ Administrator</a></center>
                                    ...
                                    {               ?>  
                                        <tr>
                                            ...
                                            <td><a href="manage-admin.php?del=<?php echo htmlentities($result->id);?>" onclick="return confirm('ເຈົ້າຕ້ອງການລຶບຂໍ້ມູນນີ້ບໍ?');"> <i class="fa fa-trash" style="color:red"></i></a></td>
                                        </tr>
                                         <?php $cnt++;} }?>
                                    </tbody>
                                    </table>
