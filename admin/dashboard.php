                ...
                <div class="row align-items-center">
                    <div class="col-sm-6">
                        <div class="breadcrumbs-area clearfix">
                            <h4 class="page-title pull-left">ໜ້າຫຼັກ</h4>
                        ...
                        <div class="col-md-4">
                            <div class="single-report">
                                <div class="s-report-inner pr--20 pt--30 mb-3">
                                    ...
                                    <div class="s-report-title d-flex justify-content-between">
                                        <h4 class="header-title mb-0"> ຈຳນວນຕຳແໜ່ງ</h4>
							...
							<div class="d-sm-flex justify-content-between align-items-center">
                                    ...
                                    <div class="trd-history-tabs">
                                        <ul class="nav" role="tablist">
                                            <li>
                                                <a class="active" data-toggle="tab" href="dashboard.php" role="tab">ລາຍການ</a>
                                            </li>
                                        </ul>
                                    </div>
                                    <select class="custome-select border-0 pr-3">
                                        ...
                                        <div class="single-table">
                                            <div class="table-responsive">
                                                ...
                                                <tr>
                                                        <td>S.N</td>
                                                        <td>ລະຫັດພະນັກງານ</td>
                                                        <td width="120">ຊື່ ແລະ ນາມສະກຸນ</td>
                                                        <td>ສາຂາ</td>
                                                        <td>ເວລາການຂໍ</td>
                                                        <td>ສະຖານະ</td>
                                                        <td></td>
                                        ...
                                        <tr>
                                            ...
                                            if($stats==1){
                                             ?>
                                                 <span style="color: green">ຢືນຢັນ <i class="fa fa-check-square-o"></i></span>
                                                 <?php } if($stats==2)  { ?>
                                                <span style="color: red">ບໍ່ຮັບການຢືນຢັນ <i class="fa fa-times"></i></span>
                                                 <?php } if($stats==0)  { ?>
                                            <span style="color: blue">ກຳລັງຢືນຢັນ <i class="fa fa-spinner"></i></span>
                                            <?php } ?>
