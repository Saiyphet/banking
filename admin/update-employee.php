                ...
                <div class="row align-items-center">
                    <div class="col-sm-6">
                        <div class="breadcrumbs-area clearfix">
                            <h4 class="page-title pull-left">ໜ້າຂໍ້ມູນພະນັກງານ</h4>
                            <ul class="breadcrumbs pull-left"> 
                                <li><a href="employees.php">ພະນັກງານ</a></li>
                                <li><span>ແກ້ໄຂຂໍ້ມູນ</span></li>
                            ...
                            <?php if($error){?><div class="alert alert-danger alert-dismissible fade show"><strong>Info: </strong><?php echo htmlentities($error); ?>
                                ...
                                <form name="addemp" method="POST">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="form-group">
                                            <label for="example-email-input" class="col-form-label">ອີເມວ</label>
                                        ...
                                        <div class="form-group">
                                            <label for="example-text-input" class="col-form-label">ເບີໂທຕິດຕໍ່</label>
                                        ...
                                        <button class="btn btn-primary" name="update" id="update" type="submit">ແກ້ໄຂຂໍ້ມູນ</button>
