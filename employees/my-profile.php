                        ...
                        <div class="row">
                            ...
                            <?php if($error){?><div class="alert alert-danger alert-dismissible fade show"><strong>Info: </strong><?php echo htmlentities($error); ?>
                                ...
                                <form name="addemp" method="POST">
                                    ...
                                    <div class="card-body">
                                        <h4 class="header-title">ຂໍ້ມູນພະນັກງານ</h4>
                                        ...
                                        <div class="form-group">
                                            <label class="col-form-label">ກາລຸນາເລືອກລາຍລະອຽດ</label>
                                        ...
                                        <button class="btn btn-primary" name="update" id="update" type="submit">ຢືນຢັນ</button>
