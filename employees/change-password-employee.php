                ...
                <div class="row align-items-center">
                    <div class="col-sm-6">
                        <div class="breadcrumbs-area clearfix">
                            <h4 class="page-title pull-left">ລະຫັດຜ່ານ</h4>
                            <ul class="breadcrumbs pull-left">
                                
                                <li><span>ລະຫັດຜ່ານ</span></li>
                            </ul>
                        </div>
                    </div>
                        ...
                        <div class="row">
                            ...
                            <?php if($error){?><div class="alert alert-danger alert-dismissible fade show"><strong>Info: </strong><?php echo htmlentities($error); ?>
                                ...
                                <form name="chngpwd" method="POST">
                                    ...
                                    <div class="card-body">
                                        <h4 class="header-title">ປ້ຽນລະຫັດຜ່ານ</h4>
                                        <p class="text-muted font-14 mb-4"></p>

                                        <div class="form-group">
                                            <label for="example-date-input" class="col-form-label">ລະຫັດຜ່ານເກົ່າ</label>
                                            <input class="form-control" id="password" type="password" autocomplete="off" name="password"  required>
                                        </div>

                                        <div class="form-group">
                                            <label for="example-date-input" class="col-form-label">ລະຫັດຜ່ານໃໝ່</label>
                                            <input class="form-control" type="password" name="newpassword" id="password" autocomplete="off" required>
                                        </div>

                                        <div class="form-group">
                                            <label for="example-date-input" class="col-form-label">ຢືນຢັນລະຫັດຜ່ານ</label>
                                            <input class="form-control" type="password" name="confirmpassword" id="password" autocomplete="off" required>
                                        </div>


                                        <button class="btn btn-primary" name="change" type="submit" onclick="return valid();">ອັບເດດລະຫັດຜ່ານ</button>
