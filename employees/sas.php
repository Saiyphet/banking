                        ...
                        <div class="menu-inner">
                            <nav>
                                <ul class="metismenu" id="menu">
                                    ...
                                    <li class="active">
                                        <a href="../sc.php" aria-expanded="true"><i
                                                class="ti-agenda"></i><span>name
                                            </span></a>
                                    </li>
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div class="data-tables">
                                            ...
                                            <a target="_blank" href="../Expdf.php?EmpId=<?php echo htmlentities($result->EmpId);?>" class="btn btn-sm btn-primary"> <i class="fa fa-file-pdf-o"></i> Print  Details</a>
                                             <input onclick="incl">
                                        </div>
                                    </div>
                                </div>
