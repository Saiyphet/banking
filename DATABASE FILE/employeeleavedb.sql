...
--
CREATE DATABASE employeeleavedb CHARACTER SET utf8 COLLATE utf8_Unicode_ci;
USE employeeleavedb;
CREATE TABLE `admin` (
  `id` int(11) NOT NULL,
...
CREATE TABLE `class` (
  `id` int(11) NOT NULL,
  `classroom` varchar(150) DEFAULT NULL,
 
  
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
INSERT INTO`class`(`id`,`classroom`)VALUES(1`E111`);
--
