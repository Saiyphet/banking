<?php
    ...
    if(isset($_POST['signin']))
    {
        ...
        if($query->rowCount() > 0)
        {
            ...
            if($status==0)
        {
            $msg="ບັນຊີຂອງທ່ານໄດ້ຖືກປິດໃຊ້ງານ ກາລຸນາຕິດຕໍ່ຫາ Admin";
        } else  {
            ...
            <div class="login-box ptb--100 ">
                ...
                <img src="./BI.png" class="img1" alt="">
                    ...
                    <div class="login-form-head">
                       ...
                       <center><?php if($msg){?><div class="errorWrap"> <?php echo htmlentities($msg); ?> </div><?php }?></center> 
                    </div>
                    <div class="login-form-body">
                        ...
                        <div class="row mb-4 rmber-area">
                            ...
                            <div class="col-6 text-right">
                                <a href="password-recovery.php">ລືມລະຫັດຜ່ານ?</a>
                            </div>
                        </div>
